...
public class LobbyServerHandler : BaseGameServerHandler<LobbyServerHandler>, IGameServerHandler
{
    ...
    {
        hitPlayer.GetComponent<PlayerHealth>()?.PlayerDamagedFeedbackClientRpc(attackingPlayer.transform.position, (long)attackingPlayer.OwnerClientId, damage, critical);
    }
