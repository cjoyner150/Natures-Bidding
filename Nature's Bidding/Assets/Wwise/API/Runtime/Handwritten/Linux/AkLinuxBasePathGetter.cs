...
public partial class AkLinuxBasePathGetter
{
	static AkLinuxBasePathGetter()
	{
#if !UNITY_2019_2_OR_NEWER
		AkBasePathGetter.AddTargetPlatform(UnityEditor.BuildTarget.StandaloneLinuxUniversal, "Linux");
#endif
		AkBasePathGetter.AddTargetPlatform(UnityEditor.BuildTarget.StandaloneLinux64, "Linux");
	}
}
#endif